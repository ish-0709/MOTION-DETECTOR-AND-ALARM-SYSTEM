...
def team():
    ...
    # Authentication
    s.login("sootkardungi@gmail.com", "@bhusha127")

    # message to be sent
    message = "Intruder trying to enter"

    # sending the mail
    s.sendmail("sootkardungi@gmail.com", "vcvjain@yahoo.com", message)
